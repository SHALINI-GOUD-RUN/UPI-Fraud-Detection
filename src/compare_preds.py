...
# 🔁 ADD SELF-LOOPS (same as in train.py)
...
print(f"\n🧾 Total fraud edges detected: {fraud_mask.sum().item()}")
print(f"👤 Unique fraudulent users: {len(unique_fraud_users)}")
print(f"🏪 Unique fraudulent merchants: {len(unique_fraud_merchants)}")
